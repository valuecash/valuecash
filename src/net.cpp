...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Valuecash " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"valuecashtools.com", "45.55.192.190"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"valuecashtools.com", "testnet-seed.valuecashtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Valuecash is probably already running."), addrBind.ToString().c_str());
        else
